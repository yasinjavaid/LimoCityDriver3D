...
public class Upsight
{
	...
	[DllImport("__Internal")]
	private static extern void _usSendContentRequestWithContentUnitID( string contentUnitID, string messageID, bool showsOverlayImmediately, bool shouldAnimate, string dimensions = null );
	...
	{
		if( Application.platform == RuntimePlatform.IPhonePlayer )
			_usSendContentRequestWithContentUnitID( contentUnitID, messageID, showsOverlayImmediately, shouldAnimate, null != dimensions ? MiniJSON.Json.Serialize( dimensions ) : null );
	}
