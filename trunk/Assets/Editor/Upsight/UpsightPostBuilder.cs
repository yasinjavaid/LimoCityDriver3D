...
public class UpsightPostBuilder : MonoBehaviour
{
	...
	private static void buildDemo()
	{
		...
		BuildPipeline.BuildPlayer( new string[] { "Assets/Plugins/Upsight/demo/UpsightDemo.unity" }, iosExportPath, BuildTarget.iPhone, BuildOptions.None );
	...
	private static void buildInternalDemo()
	{
		...
		EditorUserBuildSettings.SwitchActiveBuildTarget( BuildTarget.iPhone );
		BuildPipeline.BuildPlayer( new string[] { "Assets/Plugins/Upsight/QADemo/QADemoScene.unity" }, iosExportPath, BuildTarget.iPhone, BuildOptions.None );
